    ...
    return (
        <>
                        ...
                        <div className="modal-body">
                            <form className="my-3">
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" required id="etitle" name="etitle" value={note.etitle} aria-describedby="emailHelp" onChange={onChange} />
                                </div>
                                <div className="mb-3">
            ...
            <div className="row my-3" >
                <h2 className='text-center my-5'>You Notes</h2>
                <div className = "mx-2">
